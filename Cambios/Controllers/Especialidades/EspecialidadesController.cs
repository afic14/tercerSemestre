...
namespace SCAME.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreEspecialidad")] Especialidades especialidades)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreEspecialidad")] Especialidades especialidades)
        {
